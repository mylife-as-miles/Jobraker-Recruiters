-- =====================================================
-- UPDATE NEW USER CREDIT ALLOCATION
-- =====================================================
-- Changes:
-- 1. New users now get 50 credits only (signup bonus)
-- 2. Monthly 10 credits allocated after 1 month from registration
-- 3. Existing users keep their current balances (180 credits as bonus)
-- =====================================================
...
-- 2. Check their credits with:
--    SELECT balance FROM user_credits WHERE user_id = 'NEW_USER_ID';
-- 3. They should have 50 credits (not 60)
--
-- For monthly refills (after 1 month):
-- SELECT * FROM refill_monthly_credits();
-- SELECT * FROM record_monthly_refill_transactions();
-- =====================================================
