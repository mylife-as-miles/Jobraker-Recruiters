# Connecting Google to Jobraker Recruiter

Jobraker Recruiter requires Google OAuth credentials (Client ID and Client Secret) to connect to Gmail, Calendar, and Drive. Follow the steps below to generate them.
...
- Give it a name (e.g. `Jobraker Recruiter Integration`)
- Click **Create**

Once created, make sure the new project is selected in the top project dropdown.

![Select the new project in the dropdown](https://raw.githubusercontent.com/jobraker-recruiter/jobraker-recruiter/main/apps/docs/docs/img/google-setup/01-select-project-dropdown.png)
...
- Click **Enable**
    ...
    ![Enable the API](https://raw.githubusercontent.com/jobraker-recruiter/jobraker-recruiter/main/apps/docs/docs/img/google-setup/02-enable-api.png)
...
- App name: (e.g. `Jobraker Recruiter`)
...
![OAuth consent screen](https://raw.githubusercontent.com/jobraker-recruiter/jobraker-recruiter/main/apps/docs/docs/img/google-setup/03-oauth-consent-screen.png)
...
- Click **Add Users**
- Add the email address you plan to connect with Jobraker Recruiter

Save changes.

![Add test users](https://raw.githubusercontent.com/jobraker-recruiter/jobraker-recruiter/main/apps/docs/docs/img/google-setup/04-add-test-users.png)
...
- Name it anything (e.g. `Jobraker Recruiter Desktop`)
...
Copy **both values** and paste them into Jobraker Recruiter when prompted.

![Enter credentials in Jobraker Recruiter](https://raw.githubusercontent.com/jobraker-recruiter/jobraker-recruiter/main/apps/docs/docs/img/google-setup/07-enter-credentials.png)
