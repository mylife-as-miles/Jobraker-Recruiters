...
const IFRAME_HEIGHT_MESSAGE = 'jobraker-recruiter:iframe-height';
const SITE_RELOAD_MESSAGE = 'jobraker-recruiter:site-changed';
const SITE_EVENTS_PATH = '__jobraker-recruiter_events';
...
(() => {
  const SITE_CHANGED_MESSAGE = '__JOBRAKER_RECRUITER_SITE_CHANGED_MESSAGE__';
  const SITE_EVENTS_PATH = '__JOBRAKER_RECRUITER_SITE_EVENTS_PATH__';
  ...
  const MESSAGE_TYPE = '__JOBRAKER_RECRUITER_IFRAME_HEIGHT_MESSAGE__';
...
function injectIframeAutosizeBootstrap(html: string): string {
  const bootstrap = IFRAME_AUTOSIZE_BOOTSTRAP
    .replace('__JOBRAKER_RECRUITER_IFRAME_HEIGHT_MESSAGE__', IFRAME_HEIGHT_MESSAGE)
    .replace('__JOBRAKER_RECRUITER_SITE_CHANGED_MESSAGE__', SITE_RELOAD_MESSAGE)
    .replace('__JOBRAKER_RECRUITER_SITE_EVENTS_PATH__', SITE_EVENTS_PATH)
  if (/<\/body>/i.test(html)) {
