...
- Local HTML pages auto-expand inside Jobraker Recruiter iframe blocks to fit their content height
    ...
    <main class="shell">
      <header class="hero">
        <div>
          ...
          <h1>Signal Deck</h1>
          <p class="lede">
            A locally-served dashboard designed to live inside a Jobraker Recruiter note. It fetches
...
const fallbackRepos = [
  { ...reposConfig[0], stars: 1280, forks: 144, issues: 28, url: 'https://github.com/jobraker-recruiter/jobraker-recruiter' },
...
function renderMetrics(repos, stories) {
  ...
  const metrics = [
    {
      label: 'Jobraker Recruiter stars',
