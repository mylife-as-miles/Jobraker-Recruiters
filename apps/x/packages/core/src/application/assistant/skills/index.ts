...
const definitions: SkillDefinition[] = [
  ...
  },
  {
    id: "notify-user",
    title: "Notify User",
    summary: "Send native desktop notifications with optional clickable links — including jobraker-recruiter:// deep links that open a specific note, chat, or view inside the app.",
...
export const skillCatalog = [
  "# Jobraker Recruiter Skill Catalog",
  "",
