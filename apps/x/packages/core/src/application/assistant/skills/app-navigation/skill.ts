...
You have access to the **app-navigation** tool which lets you control the Jobraker Recruiter UI directly — opening notes, switching views, filtering the knowledge base, and creating saved views.
