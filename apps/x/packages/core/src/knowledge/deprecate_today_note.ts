...
const NOTICE_MARKER = '<!-- jobraker-recruiter-today-md-deprecated -->';
const DEPRECATION_NOTICE = `${NOTICE_MARKER}
> Jobraker Recruiter's Today.md live dashboard is paused for now while we work on a better experience. You can keep using this note as a regular markdown file. If you want Jobraker Recruiter to keep updating it automatically, re-enable the live note settings; automatic updates may use credits.
