...
3. Classify the note using the Jobraker Recruiter Tag System (Note Tags section) appended below.
...
9. **Only use tags from the Jobraker Recruiter Tag System** — do not invent new tags.
