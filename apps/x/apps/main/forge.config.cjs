...
module.exports = {
    packagerConfig: {
        ...
        appBundleId: 'com.jobraker-recruiter.app',
        appCategoryType: 'public.app-category.productivity',
        protocols: [
            { name: 'Jobraker Recruiter', schemes: ['jobraker-recruiter'] },
        ],
        extendInfo: {
            NSAudioCaptureUsageDescription: 'Jobraker Recruiter needs access to system audio to transcribe meetings from other apps (Zoom, Meet, etc.)',
        },
        osxSign: {
    ...
    makers: [
        {
            ...
            config: (arch) => ({
                format: 'ULFO',
                name: `Jobraker Recruiter-darwin-${arch}-${pkg.version}`,  // Architecture-specific name to avoid conflicts
            })
        },
        {
