...
const CONFIG = {
  ...
  API_URL: '__JOBRAKER_RECRUITER_HOST__/api/widget/v1',
  STORAGE_KEYS: {
    MINIMIZED: 'jobraker-recruiter_chat_minimized',
    SESSION: 'jobraker-recruiter_session_id'
  },
  IFRAME_STYLES: {
    MINIMIZED: {
      width: '48px',
    ...
    try {
      const response = await fetch(`${CONFIG.API_URL}/session/guest`, {
        ...
        headers: {
          ...
          'x-client-id': window.JOBRAKER_RECRUITER_CONFIG.clientId
        },
      });
