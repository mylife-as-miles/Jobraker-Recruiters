...
export interface JobrakerRecruiterApiOptions {
    baseUrl?: string;
}

export class JobrakerRecruiterApi {
    readonly baseUrl: string;
    constructor({ baseUrl }: JobrakerRecruiterApiOptions = {}) {
        this.baseUrl = baseUrl ?? process.env.JOBRAKER_RECRUITER_X_SERVER_URL ?? "http://127.0.0.1:3000";
    }
