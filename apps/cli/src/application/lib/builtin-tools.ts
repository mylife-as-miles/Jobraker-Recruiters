...
export const BuiltinTools: z.infer<typeof BuiltinToolsSchema> = {
    ...
    readFile: {
        ...
        inputSchema: z.object({
            filename: z.string().describe('The name of the file to read (relative to .jobraker-recruiter directory)'),
        }),
    ...
    createFile: {
        ...
        inputSchema: z.object({
            filename: z.string().describe('The name of the file to create (relative to .jobraker-recruiter directory)'),
    ...
    updateFile: {
        ...
        inputSchema: z.object({
            filename: z.string().describe('The name of the file to update (relative to .jobraker-recruiter directory)'),
    ...
    deleteFile: {
        description: 'Delete a file from the .jobraker-recruiter directory',
        inputSchema: z.object({
            filename: z.string().describe('The name of the file to delete (relative to .jobraker-recruiter directory)'),
        }),
        execute: async ({ filename }: { filename: string }) => {
            try {
                const filePath = path.join(BASE_DIR, filename);
    ...
    listFiles: {
        description: 'List all files and directories in the .jobraker-recruiter directory or subdirectory',
        inputSchema: z.object({
            subdirectory: z.string().optional().describe('Optional subdirectory to list (relative to .jobraker-recruiter directory)'),
        }),
    ...
    executeCommand: {
        ...
        inputSchema: z.object({
            ...
            cwd: z.string().optional().describe('Working directory to execute the command in (defaults to .jobraker-recruiter directory)'),
        }),
