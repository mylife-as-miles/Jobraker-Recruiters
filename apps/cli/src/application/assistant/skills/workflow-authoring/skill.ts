...
Load this skill whenever a user wants to inspect, create, or update agents inside the Jobraker Recruiter workspace.
...
2. **Run the orchestrator**: \`jobraker-recruiter-x --agent orchestrator_name\`
...
### 1. Builtin Tools
Internal Jobraker Recruiter tools (executeCommand, file operations, MCP queries, etc.)
...
**To run this workflow**: \`jobraker-recruiter-x --agent podcast_workflow\`
