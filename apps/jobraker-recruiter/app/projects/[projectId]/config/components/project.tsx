...
function ApiKeysSection({ projectId }: { projectId: string }) {
    ...
    return <Section 
        title="API Keys"
        description="API keys are used to authenticate requests to the Jobraker Recruiter API."
    >
        <div className="space-y-4">
...
export function ChatWidgetSection({ projectId, chatWidgetHost }: { projectId: string, chatWidgetHost: string }) {
    ...
    const code = `<!-- Jobraker Recruiter Chat Widget -->
<script>
    window.JOBRAKER_RECRUITER_CONFIG = {
