...
description: "How to contribute to Jobraker Recruiter — from bug reports to pull requests."
icon: "github"
---

# Contributing to Jobraker Recruiter

Jobraker Recruiter is open-source and we welcome contributions of all kinds — bug reports, feature ideas, code, and docs improvements.

**Quick links:**
- [GitHub Repository](https://github.com/jobraker-recruiter/jobraker-recruiter)
- [Discord Community](https://discord.gg/wajrgmJQ6b)
- [Open Issues](https://github.com/jobraker-recruiter/jobraker-recruiter/issues)

---

## Ways to Contribute

**Report bugs or suggest improvements** — If something feels off or could be better, [open an issue](https://github.com/jobraker-recruiter/jobraker-recruiter/issues/new). Include steps to reproduce for bugs, or a clear description of the improvement you have in mind.

**Fix an existing issue** — Browse [open issues](https://github.com/jobraker-recruiter/jobraker-recruiter/issues) and comment on one to let us know you're working on it.
...
1. **Fork** [jobraker-recruiter/jobraker-recruiter](https://github.com/jobraker-recruiter/jobraker-recruiter) and clone it locally.
